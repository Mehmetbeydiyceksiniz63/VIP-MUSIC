...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("hissizmehmet")
                await self.one.join_chat("hissizmehmet")
                await self.one.join_chat("hissizmehmet")
                await self.one.join_chat("hissizmehmet")
                await self.one.join_chat("hissizmehmet")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("hissizmehmet")
                await self.two.join_chat("hissizmehmet")
                await self.two.join_chat("hissizmehmet")
                await self.two.join_chat("hissizmehmet")
            except:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("hissizmehmet")
                await self.three.join_chat("hissizmehmet")
                await self.three.join_chat("hissizmehmet")
                await self.three.join_chat("hissizmehmet")
            except:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("hissizmehmet")
                await self.four.join_chat("hissizmehmet")
                await self.four.join_chat("hissizmehmet")
                await self.four.join_chat("hissizmehmet")
            except:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("hissizmehmet")
                await self.five.join_chat("hissizmehmet")
                await self.five.join_chat("hissizmehmet")
                await self.five.join_chat("hissizmehmet")
            except:
